  ...
  <div class="container">
    <div class="section-top">
      <div class="section-top-left">
        ...
        <h2>مشترياتك السابقة</h2>
        <div class="gold-line"></div>
      </div>
    </div>
    <?php foreach(array_reverse($purchases) as $purchase): ?>
    <div style="background:#fff;border:1px solid #e0dcd4;border-radius:10px;padding:20px;margin-bottom:20px;">
      <p style="font-size:12px;color:#999;margin-bottom:12px;">📅 <?php echo $purchase['date']; ?></p>
      <div style="display:flex;flex-wrap:wrap;gap:12px;">
        <?php foreach($purchase['items'] as $item): ?>
        <div style="display:flex;align-items:center;gap:10px;background:#faf6ed;padding:10px;border-radius:8px;">
          <img src="<?php echo htmlspecialchars($item['image']); ?>" style="width:50px;height:50px;object-fit:cover;border-radius:6px;">
          <div>
            <p style="font-size:13px;font-weight:700;color:#243C21;margin:0;"><?php echo htmlspecialchars($item['name']); ?></p>
            <p style="font-size:11px;color:#999;margin:2px 0 0;">SAR <?php echo $item['price']; ?> × <?php echo $item['qty']; ?></p>
          </div>
        </div>
        <?php endforeach; ?>
      </div>
    ...
    <div class="footer-grid">
      ...
      <div>
        ...
        <div class="footer-links" role="list">
          ...
          <a href="shop.php?category=Pottery">Pottery</a>
          <a href="shop.php?category=Textiles">Textiles</a>
          <a href="shop.php?category=Metalwork">Metalwork</a>
          <a href="shop.php?category=Leather">Leather</a>
          <a href="shop.php?category=Fragrance">Fragrance</a>
        </div>
      </div>
      <div>
